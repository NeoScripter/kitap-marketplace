...
export default function Navigation() {
    ...
    return <ul className="md:w-15 shadow-xl bg-black md:flex-col rounded-xl md:px-2 md:py-3 flex items-center justify-center gap-4 py-2 px-4" style={{pointerEvents: 'all'}}>
